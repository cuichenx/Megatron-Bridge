...
| DataComp image-caption pretraining | Pinned metadata slice downloaded with the official tool and converted to Qwen ChatML shards | [DataComp with Energon](datacomp/README.md) | DataComp WebDataset → `ChatMLWebdataset` → `EnergonDatasetBuilder` |
